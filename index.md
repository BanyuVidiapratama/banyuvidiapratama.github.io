...
The traditional pricing model used by the industry was based on fixed rates per KM, which did not account for fluctuations in supply and demand. In this project, I built a dynamic pricing model aiming to maximize revenue and profitability by pricing items at the right level that balances supply and demand dynamics.

<img src="images/RH portfolio.jpg?raw=true" />
